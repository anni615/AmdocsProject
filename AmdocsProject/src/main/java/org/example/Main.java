...
//                }
    ...
    public static void donorDashBoard(Scanner scanner) {
        final String url = "jdbc:mysql://localhost:3306/BloodManagementSystem";
        final String user = "root";
        final String password = "#Anni153";
        int choice = 4;
        do {
            System.out.println(" ");
            ...
            switch (choice) {
                ...
                case 2: {
                    ...
                    try  {
                        ...
                        System.out.println("3. Donor contact details");
